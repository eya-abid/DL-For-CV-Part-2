...
class AspectAwarePreprocessor:
    ...
    def preprocess(self, image):
        ...
        # if the width is smaller than the height, then resize along the width (i.e., the smaller dimension) and then update the deltas to crop the height to the desired dimension
        if w < h:
